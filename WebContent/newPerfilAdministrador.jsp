					...
					<div class="dropdown">
						...
						<div class="dropdown-content">
							<a href="newPerfilCliente.jsp">Mi Perfil</a>
							 <a href="PasajeServlet?operacion=listarPasajeCliente">Reservas</a> 
							  <a href="PasajeServlet?operacion=listarPasajeCliente">Usuarios</a>
							  <a href="PasajeServlet?operacion=listarPasajeCliente">Registrar Pasaje</a>  
